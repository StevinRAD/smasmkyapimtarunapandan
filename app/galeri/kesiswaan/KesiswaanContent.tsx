...
import { Calendar, X, Search, ArrowLeft } from "lucide-react";
...
export default function KesiswaanContent() {
  ...
  return (
    <div className="min-h-screen bg-transparent">
      <section className="section-standard bg-gradient-to-r from-rose-600 to-rose-800 text-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <Link href="/galeri" className="inline-flex items-center text-rose-200 hover:text-white mb-6 transition-colors">
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-black">Kegiatan Kesiswaan</h1>
              <p className="text-rose-200">Kegiatan OSIS, upacara, dan event kesiswaan</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-spacious bg-slate-50 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="mb-12">
            <div className="inline-flex items-center px-4 py-2 bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-400 font-bold text-xs uppercase tracking-[0.2em] rounded-full mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {kesiswaanImages.map((image, index) => (
              <motion.div
                key={index}
                  ...
                  <div className="relative aspect-[4/3] w-full overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
                        ...
                        <p className="text-rose-200 text-sm">{image.description}</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          >
            ...
            >
              ...
              <div className="text-center mt-6">
                ...
                <p className="text-rose-200 mt-2 text-sm">{previewImage.description}</p>
