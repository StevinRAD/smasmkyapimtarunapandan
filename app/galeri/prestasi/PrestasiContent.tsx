...
import { Trophy, X, Search, ArrowLeft } from "lucide-react";
...
export default function PrestasiContent() {
  ...
  return (
    <div className="min-h-screen bg-transparent">
      <section className="section-standard bg-gradient-to-r from-amber-600 to-amber-800 text-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <Link href="/galeri" className="inline-flex items-center text-amber-200 hover:text-white mb-6 transition-colors">
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-black">Prestasi & Penghargaan</h1>
              <p className="text-amber-200">Pencapaian siswa dan sekolah di berbagai kompetisi</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-spacious bg-slate-50 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="mb-12">
            <div className="inline-flex items-center px-4 py-2 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 font-bold text-xs uppercase tracking-[0.2em] rounded-full mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {prestasiImages.map((image, index) => (
              <motion.div
                key={index}
          ...
          >
            ...
            >
              ...
              <div className="text-center mt-6">
                ...
                <p className="text-amber-200 mt-2 text-sm">{previewImage.description}</p>
